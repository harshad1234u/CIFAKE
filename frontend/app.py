...
with col1:
    st.markdown("""
    ### Welcome to CIFAKE
    This application utilizes Deep Learning and Transfer Learning (MobileNetV2) to accurately distinguish between real photographs and AI-generated synthetic images.
    ...
    #### Key Features:
    * **High Accuracy:** Validated at 93.32% accuracy on the CIFAKE dataset.
